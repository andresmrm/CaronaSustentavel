...
@forbidden_view_config(renderer='proibida.plm')
...
@view_config(route_name='inicial', renderer='base.plm')
def inicial(request):
    usuario = authenticated_userid(request)
    return {"usuario":usuario}


@view_config(route_name='criar_perfil', renderer='registrar.plm')
...
@view_config(route_name='ver_perfil', renderer='ver_perfil.plm')
...
@view_config(route_name='editar_perfil', renderer='editar_perfil.plm', permission='usar')
...
@view_config(route_name='login', renderer='login.plm')
